...
import 'package:furniture_fe/models/user_model.dart';
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Widget build(BuildContext context) {
    ...
    if (!isEdit && num == 1 && userProvider.currentUser != null) {
                  ...
                  if (!isEdit) {
                    ...
                    if(_pickedImage != null) {
                      _uploadImage(image: _pickedImage!).then((value) {
                        ...
                        // TODO: Implement userProvider.updateUser(user)
                        showDialog(
                              barrierDismissible: false,
                              context: context,
                              builder: (_) {
                      ...
                      // });  // TODO: Uncomment when updateUser is implemented
                    }
                  }
                },
                child: Container(
