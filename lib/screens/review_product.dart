...
import 'package:furniture_fe/models/order_model.dart';
import 'package:furniture_fe/models/product_model.dart';
...
class _ReviewPageState extends State<ReviewPage> {
  ...
  Widget build(BuildContext context) {
    ...
    // Function to open image picker (can be called later if needed)
    ...
    if (widget.orderModel.cartList.isNotEmpty) {
      return Scaffold(
    ...
    return const Scaffold(
      body: Center(
        child: Text('No products to review'),
      ),
    );
  }
