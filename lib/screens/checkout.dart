...
class _CheckoutPageState extends State<CheckoutPage> {
  ...
  Widget build(BuildContext context) {
    ...
    if (num == 0 && userProvider.currentUser != null) {
    ...
    // TODO: Implement country/city provider methods
  ...
  void updateUpQuantity(int idCart, int quantity) {
    ...
    final cart = listCart.firstWhere((c) => c.idCart == idCart);
    cartProvider.updateQuantity(cart, quantity + 1);
  }
