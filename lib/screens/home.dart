  ...
  import 'package:furniture_fe/screens/setting.dart';
  ...
  class _HomePageState extends State<HomePage> {
    ...
    void getCallAllFunction() {
      ...
      productProvider.fetchNewArchive();
      productProvider.fetchBestReview();
      productProvider.fetchTopSeller();
                      ...
                      child: Column(mainAxisSize: MainAxisSize.max, children: [
                        Column(
                          ...
                          children: [
                            ...
                            getCategoryList(categoryProvider.categories),
                              ...
                              children: [
                                ...
                                IconButton(
                                  icon: getIconFavorite(
                                      element.id, favoriteProvider.favorites, element),
                                  onPressed: () {
                                    showDialog(
                                        context: context,
                                        builder: (_) {
                                    ...
                                    favoriteProvider.addFavorite(favorite).then((success) {
